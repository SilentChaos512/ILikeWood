...
public class WoodenHangingSignBlock extends WoodenSignBlock{
    public static final IntegerProperty ROTATION = BlockStateProperties.ROTATION_0_15;

    public WoodenHangingSignBlock(WoodType woodType, Block lootFrom) {
        super(woodType, Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.WOOD).lootFrom(lootFrom));
